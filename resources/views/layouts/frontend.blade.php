...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/9.png') }}" style="width:100%;">
    ...
    <body>
        <!-- navbar -->
        <nav class="navbar navbar-expand-lg navbar-custom shadow-sm py-3 fixed-top bg-primary" >
            <div class="container">
              
                <a class="navbar-brand text-white" href="{{ url('/') }}"><b >{{ config('app.name') }}</b></a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon text-dark pt-2"><i class="fas fa-bars" style="color:white"></i></span>
                </button>
    ...
    <footer class="bg-primary text-center text-white" style="margin-top:100px;">
      <!-- Grid container -->
      <div class="container p-4 pb-0">
        <!-- Section: Social media -->
        <section class="mb-4">
          <!-- Facebook -->
          <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/groups/59029457022/?ref=share" role="button" target="_blank">
            <i class="bi bi-facebook"></i></a>
          <!-- Instagram -->
          <a class="btn btn-outline-light btn-floating m-1" href="https://instagram.com/pakramanwidyasantika_pnb?igshid=YmMyMTA2M2Y=" role="button" target="_blank">
            <i class="bi bi-instagram"></i></a>
          <!-- Whatsapp-->
          <a class="btn btn-outline-light btn-floating m-1" href="https://api.whatsapp.com/send?phone=6282279345216" role="button" target="_blank">
