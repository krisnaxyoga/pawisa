            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="@if($model->exists) {{ route('jabatan.update', $model->id) }} @else {{ route('jabatan.store') }} @endif" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <label class="small mb-1">Sebagai<span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid" name="kategori" type="text" placeholder="nama jabatan " value="{{ old('kategori', $model->kategori) }}" />
